        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            @endif
                ...
                <a href="{{ url('/addstaffpayment') }}" class="btn btn-edit float-right"><i class="ti-plus"></i> Add</a>
                        ...
                        <p>
                            ...
                            <tbody>
                                             ...
                                             <tr>
                                                 ...
                                                 <td> {{ $i }} </td>
                                                 <td> {{ $u->details }}</td>
                                            <td><?php if ($u->p_status == 1) { ?>

                                                        <a href="{{ url('update_paymentstatus') }}/<?php echo $u->id ?>" class="btn btn-block" style="background-color: red;">
                                                                          <i class="ti-na"></i>
                                                                        </a>

                                                     <?php } else { ?>

                                                         <a href="{{ url('update_paymentstatus') }}/<?php echo $u->id ?>" class="btn btn-unblock" style="background-color: green;"> <i class="ti-unlock"></i></a>
                                                 ...
                                                 <td>
                                                     <div class="template-demo d-flex justify-content-between flex-nowrap">
                                                         <a href="{{url('editpayment',$u->id)}}" class="btn btn-edit">
                                                             <i class="ti-pencil"></i>
                                                         </a>
                                                         <a href="{{url('deletepayment',$u->id)}}" class="btn btn-delete">
                                                             <i class="ti-trash"></i>
                                                         </a>
                                                     </div>
                                                 </td>
