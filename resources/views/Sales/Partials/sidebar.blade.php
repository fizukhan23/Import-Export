<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="users-menu">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item">
            <a class="nav-link" href="{{url('liststaffbuyer')}}">Buyers</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{url('liststaffseller')}}">Sellers</a>
          </li>
        </ul>
      </div>
    </li>
  ...
  <div class="collapse" id="product-menu">
    <ul class="nav flex-column sub-menu">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ url('listsellers') }}">View Quotation</a>
      </li>
    </ul>
  </div>
</li>
  ...
  <div class="collapse" id="payment-menu">
    <ul class="nav flex-column sub-menu">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ url('listseller') }}">View Product</a>
      </li>
    </ul>
  </div>
</li>
...
<!--      <li class="nav-item">-->
<!--        <a class="nav-link" href="{{ url('liststaffpurchase') }}">View Purchase</a>-->
<!--      </li>-->
<!--    </ul>-->
<!--  </div>-->
<!--</li>-->
...
<li class="nav-item">
  ...
  <div class="collapse" id="feedback-menu">
    <ul class="nav flex-column sub-menu">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ url('liststafffeedback') }}">View Feedback</a>
      </li>
    </ul>
  </div>
</li>
...
<li class="nav-item">
  <a class="nav-link" href="{{ url('liststaffnotify') }}">
