      ...
      <div class="main-panel">        
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{url('/updatestaff',$data->id)}}" method="POST">
        ...
        @endif
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="password" name="password" value="@if (!empty($data)){{ $data->password }}@else{{ old('password') }}@endif" >
          </div>
          <div class="form-group">
