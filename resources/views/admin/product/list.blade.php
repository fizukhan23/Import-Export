  ...
  <div class="container-scroller">
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            @endif
                ...
                <div class="card-body">
                    <h4 class="card-title">sellers Product List</h4>
                    <a href="{{ url('/addproduct') }}" class="btn btn-edit float-right"><i class="ti-plus"></i> Add</a>
    ...
    <table id="dataTable" class="table">
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $i + $viewdata->firstItem() - 1 }}</td>
                <td>
                    <div class="template-demo d-flex justify-content-between flex-nowrap">
                        <a href="{{ url('listproduct', $u->id) }}" class="btn btn-edit">
                            <i class="ti-eye"></i>
                        </a>
                    </div>
                </td>
