      ...
      <div class="main-panel">        
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{url('/savestaffseller')}}" method="POST">
        ...
        @endif
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="exampleInputPassword1" placeholder="number" name="mobile" required>
          </div>
          <!--  <div class="form-group">-->
          <!--  <label for="exampleInputPassword1">Sell Product</label>-->
          <!--  <input type="text" class="form-control" id="exampleInputPassword1" placeholder="product" name="product" required>-->
          <!--</div>-->
          <!--<div class="form-group">-->
          <!--  <label for="exampleInputConfirmPassword1">No. Of Transections</label>-->
          <!--  <input type="text" class="form-control" id="exampleInputConfirmPassword1" placeholder="number" name="transection" required>-->
          <!--</div>-->
