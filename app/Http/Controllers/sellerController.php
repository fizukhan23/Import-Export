...
public function saveseller(Request $request){
   $seller = new seller;
    ...
    public function listtsellers()
{
    $data =DB::table('sellers')->paginate(7);
    return view('admin.seller.listseller', ['viewdata' => $data]);
}
...
public function update_sellerstatus($id){
    ...
    $data = DB::table('sellers')->paginate(10); // Use pagination with 10 items per page
...
public function editseller($id){
        ...
        return view('admin.seller.editseller',compact('data'));
     }
     ...
     public function updateseller(Request $request,$id){
         ...
         $data->update();
         $seller = seller::all();
        return view('admin.seller.listseller',compact('seller'));
