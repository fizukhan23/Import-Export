  ...
  <div class="container-scroller">
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            @endif
                ...
                <a href="{{ url('/addstaffbuyer') }}" class="btn btn-edit float-right"><i class="ti-plus"></i> Add</a>
                                                 ...
                                                 <td> {{ $i }} </td>
                                                  <td>
                                                     <div class="template-demo d-flex justify-content-between flex-nowrap">
                                                         <a href="{{url('editstaffbuyer',$u->id)}}" class="btn btn-edit">
                                                             <i class="ti-pencil"></i>
                                                         </a>
                                                         <a href="{{url('deletestaffbuyer',$u->id)}}" class="btn btn-delete">
                                                             <i class="ti-trash"></i>
                                                         </a>
                                                    
                                               <?php if ($u->status == 1) { ?>

                                                        <a href="{{ url('updatestaff_status') }}/<?php echo $u->id ?>" class="btn btn-block" style="background-color: red;">
                                                                          <i class="ti-na"></i>
                                                                        </a>

                                                     <?php } else { ?>

                                                         <a href="{{ url('updatestaff_status') }}/<?php echo $u->id ?>" class="btn btn-unblock" style="background-color: green;"> <i class="ti-unlock"></i></a>
    ...
    function filterData() {
      ...
      for (let i = 1; i < dataTable.rows.length; i++) {
        const date = new Date(dataTable.rows[i].cells[7].innerHTML);
