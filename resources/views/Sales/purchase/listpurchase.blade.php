        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            @endif
                ...
                <a href="{{ url('/addpurchase') }}" class="btn btn-edit float-right"><i class="ti-plus"></i> Add</a>
                                             ...
                                             <tr>
                                                 ...
                                                 <td>
                                                     <div class="template-demo d-flex justify-content-between flex-nowrap">
                                                         <a href="{{url('editpurchase',$u->id)}}" class="btn btn-edit">
                                                             <i class="ti-pencil"></i>
                                                         </a>
                                                         <a href="{{url('deletepurchase',$u->id)}}" class="btn btn-delete">
                                                             <i class="ti-trash"></i>
                                                         </a>
                                                     </div>
                                                 </td>
                                                 <td><?php if ($u->status == 1) { ?>
                                                        ...
                                                        <a href="{{ url('update_purchstatus') }}/<?php echo $u->id ?>" class="btn btn-block" style="background-color: red;">
                                                                          <i class="ti-na"></i>
                                                                        </a>

                                                     <?php } else { ?>

                                                         <a href="{{ url('update_purchstatus') }}/<?php echo $u->id ?>" class="btn btn-unblock" style="background-color: green;"> <i class="ti-unlock"></i></a>
