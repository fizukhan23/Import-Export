        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            @endif
                ...
                <div class="card-body">
                    <h4 class="card-title">sellers Quatation List</h4>
                    <a href="{{ url('/addQuatation') }}" class="btn btn-edit float-right"><i class="ti-plus"></i> Add</a>
            ...
            <tr>
                ...
                <td>
                    <div class="template-demo d-flex justify-content-between flex-nowrap">
                        <a href="{{ url('list', $u->id) }}" class="btn btn-edit">
                            <i class="ti-eye"></i>
                        </a>
                    </div>
                </td>
